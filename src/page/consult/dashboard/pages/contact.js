...
const ContactSupport = () => {
  ...
  useEffect(() => {
    const fetchTickets = async () => {
      setIsLoading(true);
      try {
        const response = await axios.get(`https://newportal-backend.onrender.com/consult/support/my-tickets/${userid}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`https://newportal-backend.onrender.com/consult/support`, {
        user: parsedData?._id,
        subject,
        message
      });
  ...
  const handleReply = async (ticketId) => {
    ...
    try {
      const response = await axios.post(`https://newportal-backend.onrender.com/consult/support/${ticketId}/messages`, {
        content: newMessage
      });
