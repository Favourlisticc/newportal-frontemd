...
const ProfilePage = () => {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://newportal-backend.onrender.com/consult/update-profile-image/",
        {
          userId: user._id,
          image: imageUrl,
        }
      ...
      setUser(updatedUser);
      localStorage.setItem("consultData", JSON.stringify(updatedUser));
  ...
  const handleEditProfile = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://newportal-backend.onrender.com/consult/edit-profile`,
        {
          userId: user._id,
          ...user,
        }
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      await axios.put(
        `https://newportal-backend.onrender.com/consult/change-password`,
        {
          userId: user._id,
